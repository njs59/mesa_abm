...
def main():
    ...
    parser.add_argument('--in_csv', type=str, default='results/state_timeseries.csv')
    parser.add_argument('--out_png', type=str, default='figs_new_sweeps/speed_vs_size.png')
