#!/usr/bin/env python3
"""
Run ABM movement conditions ONLY for the proliferative phenotype.
...
def main():
    ...
    root = project_root()
    results_dir = root / "results/results_prolif"
    ...
    # ONLY proliferative conditions
    conditions = [
        Condition("prolif_phase2_only", "proliferative", True),
        Condition("prolif_two_phase", "proliferative", False),
    ]
