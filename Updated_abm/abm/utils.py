...
DEFAULTS = {
    ...
    "physics": {
        ...
        "soft_separate": True,
        "softness": 0.15,
        "repulsion_max_iter": 8,      # NEW: cap for iterative repulsion resolution
...
# S2,121,145,7932,gamma,"(1.872995576819194, 0, 1.421743119834589)",-14927.611246253198,29861.222492506397,0.04372958325352028,1.282967087670778e-13,2,2
    ...
    #   - phase1 speed distribution + turning
...
def radius_from_size_3d(
    n_cells: int, *, cell_volume: float = DEFAULTS["physics"]["cell_volume"]
) -> float:
